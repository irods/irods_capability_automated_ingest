...
parser.add_argument(
    "--file_queue", metavar="FILE QUEUE", type=str, default="file", help="file queue"
)
parser.add_argument(
    "--path_queue", metavar="PATH QUEUE", type=str, default="path", help="path queue"
)
parser.add_argument(
    "--restart_queue",
    metavar="RESTART QUEUE",
    type=str,
    default="restart",
    help="restart queue",
)
...
parser.add_argument(
    "-u", "--url", action="store", metavar="URL", type=str, default=None, help="url"
)
